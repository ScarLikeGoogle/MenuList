...
function TabView(f) {
    ...
    var c = '<table class="tab_item"  id="{0}" border="0" cellpadding="0" cellspacing="0">'+
    	'<tr><td class="tab_item1"></td><td class="tab_item2 tab_title">{1}</td><td class="tab_item2"><div class="tab_close"></div></td><td class="tab_item3"></td></tr></table>';
